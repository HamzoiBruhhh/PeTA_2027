...
namespace Reshape.ReGraph
{
    ...
    public class RootNode : GraphNode
    {
        ...
        {
            return "This is the starting point of the graph. It only can connect to Trigger nodes.\n\nOnce specific trigger have activated, the execution is running from top to down, and left to right when multiple nodes at the same horizon level.";
        }
#endif
    }
}