...
{
    public class TextMeshProUGUITween : TweenData
    {
        ...
        [Tooltip("The shader's property used by the material of the TextMesh Pro UGUI component. Be sure to check if the current shader supports the property you want to tween (e.g.: mobile shaders have only a few properties). \n\nProperty Examples: _FaceColor, _Bevel")]
        ...
        public override Tween GetTween (TextMeshProUGUI text)
        {
            switch (command)
            {
