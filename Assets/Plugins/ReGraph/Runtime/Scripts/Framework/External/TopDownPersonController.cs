...
#endif
    public class TopDownPersonController : MonoBehaviour
    {
        [Header("Player")]
        ...
        private bool _cameraRotateEnabled = false;
        ...
        private void Move ()
        {
                ...
                currentHorizontalSpeed > targetSpeed + speedOffset)
            {
                ...
                _speed = Mathf.Lerp(currentHorizontalSpeed, targetSpeed * inputMagnitude,
                    ReTime.deltaTime * SpeedChangeRate);
            ...
            // move the player
            _controller.Move(inputDirection.normalized * (_speed * ReTime.deltaTime) +
                             new Vector3(0.0f, _verticalVelocity, 0.0f) * ReTime.deltaTime);
        ...
        private void JumpAndGravity ()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (JumpHeight > 0 &&  _input.jump && _jumpTimeoutDelta <= 0.0f)
                {
